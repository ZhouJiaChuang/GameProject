...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(CSStringBuilder), CSStringBuilderWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(CSDebug), CSDebugWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate bool __GEN_DELEGATE0( string txt);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(string), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE0(CSDebug.IsNullOrEmpty)
